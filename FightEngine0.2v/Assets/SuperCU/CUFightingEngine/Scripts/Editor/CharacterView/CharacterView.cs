...
namespace SuperCU.FightingEngine
{
    public partial class CharacterView : SceneView
    {
        ...
        public static GameObject CharacterPrefab //シーン内削除して代入
        {
            ...
            set
            {
                ...
                if (value != null)
                {
                    ...
                    characterPrefab.transform.position = new Vector3(ConstantsEditor.CHARACTER_VIEW_PLACE, 0, 0);
        ...
        public static CharacterView Open()
        {
            ...
            window.SetIconAll(0);
            //ほぼメインカメラ位置に移動
            window.LookAt(new Vector3(Camera.main.transform.position.x + ConstantsEditor.CHARACTER_VIEW_PLACE, Camera.main.transform.position.y, Camera.main.transform.position.z), window.rotation, 1);
